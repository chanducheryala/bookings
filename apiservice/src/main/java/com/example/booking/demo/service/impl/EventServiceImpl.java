...
public class EventServiceImpl implements EventService {
    ...
    private KafkaTemplate<String, EventBookingDto> kafkaTemplate;

    public EventServiceImpl(EventRespository eventRespository, SubLocationService subLocationService, UserRepository userRepository, KafkaTemplate<String, EventBookingDto> kafkaTemplate) {
